...
public class VerificationException extends Throwable {
    ...
    public VerificationException(String code, String message, List<String> messageStacks) {
        this.errorCode = code;
        this.message = message;
    ...
    public VerificationException(String code, String message, Throwable t) {
        this.errorCode = code;
        this.message = message;
        if (t != null) {
    ...
    public VerificationException(GlobalResultErrorInfo globalResultErrorInfo) {
        if (globalResultErrorInfo.getMessageStacks() != null) {
            this.messageStacks = globalResultErrorInfo.getMessageStacks();
        }
    }

    public VerificationException(String message, GlobalResultErrorInfo globalResultErrorInfo) {
        if (globalResultErrorInfo.getMessageStacks() != null) {
            this.messageStacks = globalResultErrorInfo.getMessageStacks();
        }
    }
